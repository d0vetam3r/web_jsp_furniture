...
<%
	...
	int pw_length			= request.getParameter("t_password").length();
	
	if(hobby_travel == null) hobby_travel = "n";
	if(hobby_reading == null) hobby_reading = "n";
	if(hobby_sports == null) hobby_sports = "n";
	
	Member_dto dto = new Member_dto(id, name, password, area, address, tel_1, tel_2, tel_3, gender, hobby_travel, hobby_reading, hobby_sports, reg_date, "", "", "",pw_length);
