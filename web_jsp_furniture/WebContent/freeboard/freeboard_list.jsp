...
<%	
	...
	ArrayList<Freeboard_dto> dtos = dao.getNoticeListPaging(select, search, start, end);
...
<Script>
	...
	function goView(no){
		view.v_no.value=no;
		//view.method="post";
		view.action="freeboard_view.jsp";
		view.submit();
	...
	function goSearch(){
		...
		s_search.action="/freeboard/freeboard_list.jsp";
		s_search.submit;
	}
</Script>
<form name ="pageForm">
