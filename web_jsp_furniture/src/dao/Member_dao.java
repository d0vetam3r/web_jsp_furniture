...
public class Member_dao {
	...
	public Member_dto viewMember(String id) {
		...
		String query ="select id, name, password,area, address, tel_1,tel_2,tel_3,\r\n" + 
				...
				"hobby_travel, hobby_reading, hobby_sports, pw_length\r\n" + 
		...
		try {
			...
			if (rs.next()) {
				...
				int pw_length		 = rs.getInt(17);
				dto = new Member_dto(id, name, password, area, address, tel_1, tel_2, tel_3, gen, hobby_traval, hobby_reading, hobby_sports, reg_date, level_gubun, exit_gubun, exit_date, pw_length);
	...
	public Member_dto getMemberView(String id) {
		Member_dto dto = null;
		String query = "select id, name, password, area, address, tel_1, tel_2, tel_3, gen, hobby_travel, hobby_reading, hobby_sports, to_char(reg_date,'yyyy-MM-dd') as reg_date, pw_length\r\n" + 
				"from homepage_김세훈_member where id = '"+id+"'";
		try {
			con = DBConnection.getConnection();
			ps = con.prepareStatement(query);
			...
			if(rs.next()) {
				...
				String tel_3 		 = rs.getString(8);
				String gen			 = rs.getString(9);
				String hobby_traval	 = rs.getString(10);
				String hobby_reading = rs.getString(11);
				String hobby_sports  = rs.getString(12);
				String reg_date 	 = rs.getString(13);
				int pw_length		 = rs.getInt(14);
				
				dto = new Member_dto(id, name, password, area, address, tel_1, tel_2, tel_3, gen, hobby_traval, hobby_reading, hobby_sports, reg_date, "", "", "", pw_length);
			}
		}
		catch(SQLException e) {
			e.printStackTrace();
	...
	public int memberSave(Member_dto dto) {
		...
		String query = "insert into homepage_김세훈_member\r\n" + 
				"(id, name, password, area, address, tel_1, tel_2, tel_3, gen, hobby_travel, hobby_reading, hobby_sports, reg_date,pw_length)\r\n" + 
				"values\r\n" + 
				...
				"'"+dto.getHobby_reading()+"', '"+dto.getHobby_sports()+"', '"+dto.getReg_date()+"','"+dto.getPw_length()+"')";
