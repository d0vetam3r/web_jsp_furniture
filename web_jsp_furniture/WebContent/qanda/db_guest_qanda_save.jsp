...
<%
	...
	String is_guest = "y";
	String guest_id = request.getParameter("t_guest_id");
	String guest_pw = request.getParameter("t_guest_pw");
	...
	out.print("guest_id	 : " + guest_id 	+ "<br>");
	out.print("guest_pw	 : " + guest_pw 	+ "<br>");
	out.print("no		 : " + no			+ "<br>");
	Qanda_dto dto = new Qanda_dto(no,title,content,reg_id,reg_date,is_guest,guest_id,guest_pw,pub_pri);
